  ...
  <div>
    <el-form label-width="100px">
      ...
      <el-form-item label="SPU品牌">
        <el-select style="width: 200px" placeholder="请您选择品牌" v-model="SpuParams.tmId">
...
const initHasSpuData = async (spu: SpuData) => {
  try {
    ...
    console.error("Error initializing SPU data:", error);
...
const save = async () => {
  ...
  let result = await reqAddOrUpdateSpu(<SpuData>SpuParams.value);
  if (result.code == 200) {
    ElMessage({
      type: 'success',
