<template>
  <el-card style="height: 80px">
    <el-form :inline="true" class="form">
      <el-form-item label="职位搜索">
        <el-input placeholder="请您输入搜索职位关键词" v-model="keyword"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <el-card style="margin: 10px 0">
    ...
    <el-table border style="margin: 10px 0" :data="allRole">
      ...
      <el-table-column align="center" label="id" width="70px" prop="id"></el-table-column>
      ...
      <el-table-column align="center" width="270px" label="操作">
        <template #="{row,$index}">
