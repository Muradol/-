...
export default await (function () { return __awaiter(void 0, void 0, void 0, function () {
    function __VLS_template() {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("tabbar") }));
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("tabbar_left") }));
        // @ts-ignore
        [Breadcrumb, Breadcrumb,];
        // @ts-ignore
        var __VLS_0 = __VLS_asFunctionalComponent(Breadcrumb, new Breadcrumb({}));
        var __VLS_1 = __VLS_0.apply(void 0, __spreadArray([{}], __VLS_functionalComponentArgsRest(__VLS_0), false));
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("tabbar_right") }));
        // @ts-ignore
        [Setting, Setting,];
        // @ts-ignore
        var __VLS_5 = __VLS_asFunctionalComponent(Setting, new Setting({}));
        var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([{}], __VLS_functionalComponentArgsRest(__VLS_5), false));
        __VLS_styleScopedClasses['tabbar'];
        __VLS_styleScopedClasses['tabbar_left'];
        __VLS_styleScopedClasses['tabbar_right'];
        var __VLS_slots;
    ...
    var _a, defineProps, defineSlots, defineEmits, defineExpose, defineModel, defineOptions, withDefaults, __VLS_fnComponent, __VLS_functionalComponentProps, __VLS_self;
